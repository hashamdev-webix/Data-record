...
const Bookings = () => {
  ...
  const [filters, setFilters] = useState({
    search: "", area: "", cleaningType: "", date: "", minPrice: "", maxPrice: "",
  });
  ...
  const resetFilters = () => {
    setFilters({ search: "", area: "", cleaningType: "", date: "", minPrice: "", maxPrice: "" });
      ...
      <div className="mx-auto max-w-7xl">
        <div className="mb-8 overflow-hidden rounded-3xl bg-gradient-to-r from-blue-700 via-blue-600 to-cyan-500 p-8 shadow-2xl">
          <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
            <div>
              ...
              <h1 className="text-4xl font-extrabold text-white">Booking Records</h1>
              <p className="mt-3 max-w-2xl text-blue-100">
                View, filter, edit, and manage all cleaning service records.
              </p>
            </div>
            <Link to="/add"
        ...
        <form onSubmit={handleSearch}
          ...
          <div className="mb-5">
            ...
            <p className="text-sm text-slate-500">Search by name, service, area, date, or price range.</p>
          </div>
          <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-6">
            ...
            <input type="number" name="minPrice" placeholder="Min Price"
              value={filters.minPrice} onChange={handleFilterChange} className={inputClass} />
            <input type="number" name="maxPrice" placeholder="Max Price"
              value={filters.maxPrice} onChange={handleFilterChange} className={inputClass} />
          </div>
              ...
              <tbody className="divide-y divide-slate-100">
                {bookings.length > 0 ? (
                  bookings.map((booking) => (
                    <tr key={booking._id} className="transition-all duration-200 hover:bg-blue-50/70">
                      ...
                      <td className="px-5 py-4 text-slate-600">{booking.addedBy || "-"}</td>
                      <td className="px-5 py-4">
                    ...
                    <td colSpan="8" className="px-6 py-16 text-center">
                      <div className="mx-auto max-w-md">
                        ...
                        <p className="mt-2 text-slate-500">
                          Try changing filters or add your first customer booking.
                        </p>
                      </div>
                    </td>
                  </tr>
            ...
            <div className="w-full max-w-3xl overflow-hidden rounded-3xl bg-white shadow-2xl">
              ...
              <div className="max-h-[75vh] overflow-y-auto p-6">
                <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                  ...
                  <Detail label="Added By" value={selectedBooking.addedBy || "-"} />
                  <div className="md:col-span-2">
                    <Detail label="Full Address" value={selectedBooking.fullAddress} />
                  </div>
                  <div className="md:col-span-2">
                    <Detail label="Scope of Work" value={selectedBooking.scopeOfWork || "-"} />
                  </div>
                  <div className="md:col-span-2">
                ...
                <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                  <Link to={`/edit/${selectedBooking._id}`}
